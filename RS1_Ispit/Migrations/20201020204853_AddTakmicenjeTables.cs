...
{
    public partial class AddTakmicenjeTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TakmicenjeStavke", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TakmicenjeStavke_OdjeljenjeStavka_OdjeljenjeStavkaId",
                        column: x => x.OdjeljenjeStavkaId,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TakmicenjeStavke_Takmicenja_TakmicenjeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TakmicenjeStavke_OdjeljenjeStavkaId",
                table: "TakmicenjeStavke",
                column: "OdjeljenjeStavkaId");

            migrationBuilder.CreateIndex(
                name: "IX_TakmicenjeStavke_TakmicenjeId",
                table: "TakmicenjeStavke",
                column: "TakmicenjeId");
        }
